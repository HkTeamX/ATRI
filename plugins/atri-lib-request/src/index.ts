import type { PluginOptions } from '@atri-bot/core'
...
export function RequestPlugin(options: RequestPluginConfig = {}) {
  return definePlugin<RequestPluginProps, object>(() => {
    let kyInstance = ky.create(options.kyOptions)

    const plugin: PluginOptions<RequestPluginProps, object> = {
